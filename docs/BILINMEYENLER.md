...
- [KOL-C-Web][04.08] Yasal metinlerdeki **işletme kimlik bilgileri** (ticari unvan, merkez adresi, vergi dairesi/no, MERSİS, KEP, telefon) verilmedi. | Etkilenen: `website/app/kvkk/page.tsx`, `website/app/mesafeli-satis/page.tsx`, `website/app/iletisim/page.tsx` | Geçici çözüm: metinlerin yapısı gerçek içerikle yazıldı; kimlik alanları **uydurulmadı**, `components/legal-notice.tsx` bileşeni "yayın öncesi tamamlanacak" uyarısını gösteriyor. Bilgiler gelince bileşen kaldırılacak.
