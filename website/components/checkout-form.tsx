  ...
  return (
    <form onSubmit={onSubmit} noValidate className="space-y-6">
      ...
      <button
        ...
        className="w-full rounded-lg bg-brand-600 px-4 py-3.5 text-base font-semibold text-neutral-0 hover:bg-brand-700 disabled:bg-neutral-200 disabled:text-neutral-600"
      >
